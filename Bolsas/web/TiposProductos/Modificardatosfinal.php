...
$TipodeMaterial=$_REQUEST['tipodematerial'];
$Pais=$_REQUEST['pais'];

$queryi="update tiposproductos set nombre='$Nombre',marca='$Marca',color='$Color',tipodematerial='$TipodeMaterial',pais='$Pais' where id='$codigo'";//consulta sql
...
echo "<a href='editarTipoProducto.php'>Regresar</a>";
}
}
?>
<br/><br/> 
